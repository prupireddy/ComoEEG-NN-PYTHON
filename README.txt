...
belongs to CNN V5. This works off of CNN_V4
...
There should be no other folders in that directory. If you work through all of the code in the MATLAB's CNN V5, you should be able to accomplish this. 
