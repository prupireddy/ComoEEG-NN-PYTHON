...
belongs to CNN V4. This works off of CNN V1, or master. 
...
There should be no other folders in that directory. If you work through all of the code in the MATLAB's CNN V4. You should be able to accomplish this. 
